<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<li class="nav-item dropdown">
			...
			<img src="https://gravatar.com/avatar/{{ md5(auth()->user()->email) }}?s=800&d=identicon&r=g" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded">
			<img src="https://gravatar.com/avatar/{{ md5(auth()->user()->email) }}?s=800&d=identicon&r=g" alt="User-Profile" class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded">
			<img src="https://gravatar.com/avatar/{{ md5(auth()->user()->email) }}?s=800&d=identicon&r=g" alt="User-Profile" class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded">
			<img src="https://gravatar.com/avatar/{{ md5(auth()->user()->email) }}?s=800&d=identicon&r=g" alt="User-Profile" class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded">
			<img src="https://gravatar.com/avatar/{{ md5(auth()->user()->email) }}?s=800&d=identicon&r=g" alt="User-Profile" class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded">
			<img src="https://gravatar.com/avatar/{{ md5(auth()->user()->email) }}?s=800&d=identicon&r=g" alt="User-Profile" class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded">
			...
			<li>
				...
				{{ Form::open(['route'=>'logout','class'=>'d-none']) }}
                {{ Form::close() }}
			</li>
			</ul>
		</li>
